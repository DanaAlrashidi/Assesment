...
function isProductCategoryMatching(product, category) {
  // Your code here
  return products.some((x) => x.category == category);
}
...
function countElectronicsProducts(products) {
  // Your code here
  return products.filter((x) => x.category.includes(products)).length;
}
...
function listProductNamesByCategory(products, category) {
  // Your code here
  return products.filter((x) => x.category.includes(category));
}
